...
/*Função principal*/
function Aprofundamento(){
    window.alert("Ao diminuir o Raio R de interceptação entre o robô e a bola, o robô tende a demorar mais tempo para alcançar o ponto de interceptação. O que se confirma com os gráficos abaixo e as informações impressas no console.");
